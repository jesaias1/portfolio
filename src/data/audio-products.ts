...
export const audioProducts: AudioProduct[] = [
  {
    ...
    commerce: {
      mode: "free",
      statusLabel: "Preview installer",
      priceLabel: "Free Windows preview",
      trialNote:
        "ORVO is currently being refined, but a Windows x64 preview installer is available for testing the standalone build.",
    },
    currentVersion: {
      version: "1.0.0 preview",
      date: "2026-08-11",
      notes: [
        "Windows x64 setup installer added for the standalone preview build.",
    ...
    compatibility: [
      "Windows x64 standalone preview installer",
      "VST3 compatible host target in testing",
      "Built with C++20 and JUCE 8",
      "Final desktop release targets will be confirmed before launch",
    ],
    installation: [
      "Download the Windows x64 setup installer from the ORVO page.",
      "Run the installer and launch the standalone ORVO preview build.",
      "Use it as a test build while final plugin compatibility and release details are refined.",
    ],
    betaLimitations: [
      "ORVO is a preview build and may change before a formal release.",
